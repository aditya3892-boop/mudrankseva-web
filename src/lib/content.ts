...
export const CONTENT = {
  en: {
    ...
    calc: {
      ...
      units: { sqmt: "Square Meter", sqft: "Square Foot", guntha: "Guntha", acre: "Acre" },
      unlockBtn: "Unlock Detailed Breakdown",
      marathiMode: "मराठीत माहिती भरा",
    },
  },
  mr: {
    ...
    calc: {
      ...
      fromArea: "क्षेत्र × दर",
      unitLabel: "एकक निवडा",
      units: { sqmt: "चौरस मीटर", sqft: "चौरस फूट", guntha: "गुंठा", acre: "एकर" },
      unlockBtn: "संपूर्ण तपशील पाहा",
      marathiMode: "मराठीत माहिती भरा",
    },
  },
} as const;
