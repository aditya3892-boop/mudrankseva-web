...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/about-mr`,          lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE}/contact-mr`,        lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE}/privacy-policy-mr`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE}/terms-mr`,          lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE}/refund-policy-mr`,  lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE}/disclaimer-mr`,     lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    ...cityEntries,
    ...blogEntries,
  ];
}
